...
const HomePage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (totalSize > MAX_TOTAL_SIZE) {
      alert(
        `Total file size (${(totalSize / 1024 / 1024).toFixed(1)}MB) exceeds the 5MB limit. Please remove some files.`,
      );
      return;
    }
  ...
  const services: Service[] = [
    {
      icon: '👕',
      title: 'Wearable Art',
      description: 'Elevate your wardrobe with hand-embroidered designs.',
    ...
    },
    {
      ...
      description: 'Add warmth to your home with embroidered décor.',
      color: 'from-[#bba987]/35 to-[#bba987]/55',
    },
    {
      icon: '✨',
      title: 'One-of-a-Kind Creations',
      description: 'Collaborate on unique hand-embroidered pieces.',
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-8">
              <div className="bg-white/80 backdrop-blur-lg rounded-3xl p-8 shadow-xl border border-[#bba987]/30 transform hover:scale-105 transition-transform duration-300">
                <p className="text-lg text-[#4e4637] leading-relaxed mb-6">
                  ...
                  <span className="text-[#bba987] font-semibold">
                    handmade beauty
                  </span>
                  . Every piece I create is infused with love, care, and
                  countless hours of passionate craftsmanship.
                </p>
                <p className="text-lg text-[#4e4637] leading-relaxed mb-6">
                  From{' '}
                  <span className="text-[#bba987] font-semibold">
                  ...
                  , I work to bring your vision to life.
                </p>
                <p className="text-lg text-[#4e4637] leading-relaxed">
                  ...
                  together, something that will be treasured for years to come!
                </p>
              </div>
              <div className="flex flex-wrap gap-3">
                {[
                  ...
                  <span
                    key={index}
                    className="px-4 py-2 bg-[#bba987]/30 text-[#4e4637] rounded-full text-sm font-medium shadow-md hover:shadow-lg hover:bg-[#bba987]/50 transition-all duration-300"
                  >
                    {badge}
                  </span>
                ))}
            ...
            <div className="relative">
              ...
              <div className="relative bg-white/90 backdrop-blur-lg rounded-3xl p-8 shadow-2xl border border-[#bba987]/30 text-center transform hover:rotate-1 transition-transform duration-300">
                ...
                <h3 className="text-2xl font-serif text-[#4e4637] mb-4">
                  Made with care
                </h3>
                <p className="text-[#4e4637]/80 italic">
                ...
                <div className="mt-6 flex justify-center space-x-2">
                  {[...Array(5)].map((_, i) => (
                    <Star
                      key={i}
                      className="w-5 h-5 text-[#bba987] fill-current animate-pulse"
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {services.map((service, index) => (
              <div key={index} className="group relative">
                <div
                  className={`absolute inset-0 bg-gradient-to-br ${service.color} rounded-3xl blur-xl opacity-0 group-hover:opacity-60 transition-opacity duration-500`}
                ></div>
                <div className="relative bg-white/80 backdrop-blur-lg rounded-3xl p-8 shadow-xl border border-[#bba987]/30 h-full text-center group-hover:scale-105 transition-transform duration-300">
                  ...
                  <h3 className="text-xl font-serif text-[#4e4637] mb-4">
                    {service.title}
                  </h3>
                  <p className="text-[#4e4637]/80 leading-relaxed">
                    {service.description}
                  </p>
        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-[#4e4637]/70 max-w-2xl mx-auto">
              Tell me about your dream embroidery project! Include as many
              details as possible and attach reference images if you have them.
            </p>
          </div>
                ...
                <label className="w-full p-6 border-2 border-dashed border-[#bba987]/50 rounded-xl bg-white/80 cursor-pointer flex flex-col items-center justify-center hover:border-[#bba987] hover:bg-[#bba987]/5 transition-all duration-300 relative">
                  ...
                  {isCompressing && (
                    <div className="absolute inset-0 bg-white/90 rounded-xl flex items-center justify-center">
                      <div className="text-[#bba987] font-medium">
                        Compressing images...
                      </div>
                    </div>
                  )}
                ...
                {selectedFiles.length > 0 && (
                  <div className="bg-[#bba987]/10 rounded-xl p-4">
                    <p className="text-[#4e4637]/70 text-sm mb-3">
                      Selected files ({selectedFiles.length}) • Total size:{' '}
                      {(totalSize / 1024 / 1024).toFixed(1)} MB / 5.0 MB
                    </p>
                    <div className="flex flex-wrap gap-3">
            ...
            <p className="text-[#4e4637]/80 mb-6 leading-relaxed">
              ...
              {!alertMessage.includes('successfully') && (
                <span className="text-sm">
                  ...
                  You can{' '}
                  <a
                    href="https://m.me/embroiderycosycorner"
                    className="text-[#bba987] underline"
                  >
                    Send us a Message
                  </a>{' '}
                  or email us at{' '}
                  <a href="mailto:hello@cosycornerembroidery.com">
                    hello@cosycornerembroidery.com
                  </a>
                  .
                </span>
              )}
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            >
              ...
              <h3 className="text-xl font-semibold mb-4 text-[#4e4637]">
                Follow Us
              </h3>
              <p className="text-[#4e4637]/70">
                Stay updated with my latest creations!
              </p>
            </div>
            <div
              onClick={() => window.open('https://m.me/embroiderycosycorner')}
              className="bg-white/80 backdrop-blur-lg cursor-pointer rounded-3xl p-8 shadow-xl border border-[#bba987]/30 transform hover:scale-105 transition-transform duration-300"
            >
              ...
              <p className="text-[#4e4637]/70">
                Reach out for custom requests or questions!
              </p>
            </div>
            <div
              onClick={() =>
            ...
            >
              ...
              <p className="text-[#4e4637]/70">
                Check out what my customers have to say about their custom
                creations!
              </p>
            </div>
          </div>
        ...
        <div className="relative z-10 max-w-6xl mx-auto text-center">
          <div className="mb-6">
            ...
            <p className="text-[#fff]/80">
              Handmade embroidery to warm your heart & home
            </p>
          </div>
